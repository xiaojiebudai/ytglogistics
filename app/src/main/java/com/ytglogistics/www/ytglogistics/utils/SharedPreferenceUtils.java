...
public class SharedPreferenceUtils {
     ...
     * 登录的打印机IP
     */
    private static String SHARED_KEY_IS_WIFI = "is_wifi";
     ...
     * @param info
     */
    public void saveIsWifi(boolean info) {
        editor.putBoolean(SHARED_KEY_IS_WIFI, info);
        editor.commit();
    }
    ...
    public boolean getIsWifi() {
        return mSharedPreferences.getBoolean(SHARED_KEY_IS_WIFI, true);
    }
