package com.ytglogistics.www.ytglogistics.service;
...
public class UpdateVersionService extends Service {
            ...
            while ((readsize = is.read(buffer)) > 0) {
                ...
                if ((downloadCount == 0)
                    ...
                    updateNotification=  new Notification.Builder(this).
                            setContentText( "拼命下载中，请稍后"+(int) totalSize * 100 / updateTotalSize + "%")
                            .setContentTitle(getString(R.string.app_name)).setContentIntent(updatePendingIntent)
                            .setSmallIcon(R.mipmap.logo).build();
                    updateNotificationManager.notify(0, updateNotification);
                }
            ...
            switch (msg.what) {
                case DOWNLOAD_COMPLETE:
                    ...
                    updateNotification=  new Notification.Builder(UpdateVersionService.this).
                            setContentText( "下载完成,点击安装。").setContentIntent(updatePendingIntent)
                            .setContentTitle(getString(R.string.app_name)).setDefaults(Notification.DEFAULT_SOUND)
                            .setSmallIcon(R.mipmap.logo).build();
                ...
                case DOWNLOAD_FAIL:
                    // 下载失败
                    updateNotification=  new Notification.Builder(UpdateVersionService.this).
                            setContentText( "下载出错了").setContentIntent(updatePendingIntent)
                            .setContentTitle(getString(R.string.app_name)).setDefaults(Notification.DEFAULT_SOUND)
                            .setSmallIcon(R.mipmap.logo).build();
    ...
    public void cleanUpdateFile() {
        ...
        File updateFile = new File("app/download/", "wwshb.apk");
        if (updateFile.exists()) {
