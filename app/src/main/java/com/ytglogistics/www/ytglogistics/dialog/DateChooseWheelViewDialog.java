...
import com.ytglogistics.www.ytglogistics.widget.OnWheelScrollListener;
import com.ytglogistics.www.ytglogistics.widget.WheelView;
import com.ytglogistics.www.ytglogistics.widget.adapters.AbstractWheelTextAdapter;
...
//                    dateChooseInterface.getDateTime(strTimeToDateFormat(mYearStr, mDateStr), mBlnBeLongTerm);
     ...
     * @return
     */
    private long strTimeToDateFormat(String yearStr, String dateStr, String hourStr, String minuteStr) {
        String s = yearStr.replace("年", "-") + dateStr.replace("月", "-").replace("日", "-")
    ...
    public interface DateChooseInterface {
        void getDateTime(long time, boolean longTimeChecked);
    }
